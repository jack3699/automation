...
//@StructName:MySocketInfo(_MySocketInfo)
...
// 接受客户端线程列表
//@Pthread_tName:arrThrReceiveClient
...
/*
@Described:
@Function: *fun_thrAcceptHandler
@Parameter: *socketListen
@Return: void
*/
void *fun_thrAcceptHandler(void *socketListen){
    while(1){
...
/*
@Described:
@Function: *fun_thrReceiveHandler
@Parameter: void *socketInfo
@Return: void
*/
void *fun_thrReceiveHandler(void *socketInfo){
	char buffer[30];
...
/*
@Described:
@Function: checkThrIsKill
@Parameter: pthread_t thr
@Return: int
*/
int checkThrIsKill(pthread_t thr){
    int res = 1;
